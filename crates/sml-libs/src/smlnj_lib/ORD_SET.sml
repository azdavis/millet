...
structure AtomSet : ORD_SET
  where type Key.ord_key = Atom.atom
  = struct end

structure AtomBinarySet : ORD_SET
  where type Key.ord_key = Atom.atom
  = struct end

structure AtomRedBlackSet : ORD_SET
  where type Key.ord_key = Atom.atom
  = struct end
...
structure IntRedBlackSet : ORD_SET
  where type Key.ord_key = int
  = struct end

structure WordRedBlackSet : ORD_SET
