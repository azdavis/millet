...
signature GENERIC_SOCK (* OPTIONAL *) = sig
  ...
  (*!
  socketPair (af, st) creates an unnamed pair of connected sockets in the address family specified
  by af and the socket type specified by st, with the default protocol.
  !*)
