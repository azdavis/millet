(*!
 * The structure Posix.Signal defines the symbolic names of all the POSIX signals (see Section 3.3
 * of the POSIX standard 1003.1,1996[CITE]), and provides conversion functions between them and
