(*!
This structure accesses the information contained in the network protocol data base. The data may be
retrieved from a file, such as /etc/protocols on many Unix systems, or via the NIS protocols map.
!*)
