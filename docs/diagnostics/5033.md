...
For lists and options, consider whether you need to access the values inside the constructors (e.g. the head or tail of the list, or the value in a `SOME`.) If you do, use pattern matching.
